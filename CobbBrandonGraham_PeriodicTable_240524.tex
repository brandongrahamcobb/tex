...
\newcommand{\NaturalElem}[4]{\ElemLabel{\color{black}#1}{\color{black}#2}{\color{black}{\huge #3}}{\color{black}#4}}

\newcommand{\SyntheticElem}[4]{\ElemLabel{\color{black}#1}{\color{black}#2}{\color{gray}{\huge #3}}{\color{black}#4}}
...
\begin{tikzpicture}[font=\sffamily]
  ...
  \node[right of=No, LanthanideActinide] (Lr) {\SyntheticElem{103}{266}{Lr}{Lawrencium}};
